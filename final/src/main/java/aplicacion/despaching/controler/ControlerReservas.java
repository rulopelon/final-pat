...
public class ControlerReservas {
	...
	public ResponseEntity<String>  realizarReserva(@RequestBody Reserva reserva,@PathVariable(value = "idAlumno") String idAlumno,@PathVariable(value="idProfesor")String idProfesor) {
